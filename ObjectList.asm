...
; The main game loop - Do everything needed, then wait for next frame
gmloop	JSR clrscn							; Clear the screen at the start of each re-draw

		JSR drwObj
		JSR incObj
		
		JSR wait1							; End of frame wait
		JSR wait1							; End of frame wait
		JSR wait1							; End of frame wait
		JSR wait1							; End of frame wait
		JSR wait1							; End of frame wait
...
; Spin the CPU for roughly one-twentyith second
wait1	LDY #$16
reset1	LDX #$FF
waitlp1	DEX
		CPX #$0
